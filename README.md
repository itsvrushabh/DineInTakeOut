...
- Billing (`p`) opens a prompt for the customer's 10-digit mobile number; it is printed on the receipt and stored with the order.
...
- AC-room seating adds a 6% AC charge plus 5% GST (applied on food + AC charge), per India tax rules.
