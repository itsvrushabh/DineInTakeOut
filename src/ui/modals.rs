...
pub fn render_help(f: &mut Frame, _app: &App) {
    ...
    let text = vec![
        ...
        Line::from("↑↓: area · ←→: table"),
        Line::from("1-9: jump to area"),
        Line::from("Enter: open/switch/clean"),
        Line::from("s: next stage · t: takeout"),
        Line::from("c: cancel/close order"),
        Line::from("r: mark table ready"),
        Line::from(""),
        Line::from("--- Recent Bills ---"),
        Line::from("↑↓: review"),
        Line::from(""),
        Line::from("--- General ---"),
        Line::from("Tab/Shift+Tab: Focus panels"),
        Line::from("/: Focus menu search · p/b: bill"),
        Line::from("x/Delete: Remove cart item"),
        Line::from("=/-: Adjust quantity"),
        Line::from("e/i: Export/Import config"),
